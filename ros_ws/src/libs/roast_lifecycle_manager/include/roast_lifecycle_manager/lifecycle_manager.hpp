#ifndef ROAST_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
#define ROAST_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
...
/**
 * @class roast_lifecycle_manager::LifecycleManager
...
class LifecycleManager : public rclcpp::Node {
 public:
  /**
   * @brief A constructor for roast_lifecycle_manager::LifecycleManager
   * @param options Additional options to control creation of the node.
   */
  explicit LifecycleManager(
      const rclcpp::NodeOptions &options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for roast_lifecycle_manager::LifecycleManager
   */
  ~LifecycleManager();
 ...
 protected:
   ...
   */
  bool changeStateForNode(const std::string &node_name,
...
#endif  // ROAST_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
