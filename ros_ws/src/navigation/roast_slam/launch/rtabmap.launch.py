...
def configure_octomap_node():
    return Node(
        ...
        parameters=[
            ...
            {"probabilityHit": LaunchConfiguration("octomap_prob_hit")},
            {"probabilityMiss": LaunchConfiguration("octomap_prob_miss")},
            {"thresholdMin": LaunchConfiguration("octomap_thres_min")},
            {"thresholdMax": LaunchConfiguration("octomap_thres_max")},
        ],
        remappings=[
    ...
    return [
        ...
        Node(
            ...
            remappings=[
                ...
                ("rgbd_image", "/camera/depth/image_rect_raw"),
            ],
            namespace=LaunchConfiguration("namespace"),
        ),
        # Relays Stereo
        ...
        Node(
            ...
            remappings=[
                ...
                (
                    ...
                    LaunchConfiguration("rgbd_topic_relay"),
                ),
            ],
            namespace=LaunchConfiguration("namespace"),
        ),
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "rgb_topic", default_value="/camera/color/image_raw", description=""
            ),
            DeclareLaunchArgument(
                "depth_topic",
            ...
            DeclareLaunchArgument(
                ...
                description="Already synchronized RGB-D related topic, e.g., with rtabmap_ros/rgbd_sync nodelet.",
            ),
            DeclareLaunchArgument(
                "rgbd_topic", default_value="rgbd_image", description=""
            ),
            DeclareLaunchArgument("depth_scale", default_value="1.5", description=""),
            ...
            DeclareLaunchArgument(
                "octomap_resolution",
                default_value="0.05",
                description="Resolution (voxel size) of the OctoMap.",
            ),
            DeclareLaunchArgument(
                "octomap_prob_hit",
                default_value="0.7",
                description="Probability of an occupied voxel when a ray sensor reading hits the voxel.",
            ),
            DeclareLaunchArgument(
                "octomap_prob_miss",
                default_value="0.4",
                description="Probability of an occupied voxel when a ray sensor reading misses the voxel.",
            ),
            DeclareLaunchArgument(
                "octomap_thres_min",
                default_value="-0.5",
                description="Minimum threshold on the log-odds value in the OctoMap for occupancy classification.",
            ),
            DeclareLaunchArgument(
                "octomap_thres_max",
                default_value="0.5",
                description="Maximum threshold on the log-odds value in the OctoMap for occupancy classification.",
            ),
            configure_octomap_node(),
            # User Data
            DeclareLaunchArgument(
                "subscribe_user_data",
                default_value="false",
