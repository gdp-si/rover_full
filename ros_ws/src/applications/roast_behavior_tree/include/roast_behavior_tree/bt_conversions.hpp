...
#ifndef ROAST_BEHAVIOR_TREE__BT_CONVERSIONS_HPP_
#define ROAST_BEHAVIOR_TREE__BT_CONVERSIONS_HPP_
...
inline geometry_msgs::msg::PoseStamped convertFromString(const StringView key) {
  ...
  if (parts.size() != 9) {
    ...
    pose_stamped.header.stamp =
        rclcpp::Time(BT::convertFromString<int64_t>(parts[0]));
...
#endif  // ROAST_BEHAVIOR_TREE__BT_CONVERSIONS_HPP_
